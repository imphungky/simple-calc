...
function Register({isLogged, invalidUser, invalidPass, invalidEmail,clearErr, register}) {
    ...
    return (
                                ...
                                <FormControl isInvalid={form.errors.password && form.touched.password}>
                                    <InputGroup>
                                        <InputLeftAddon children={<LockIcon />}/>
                                            <Input {...field} type={passwordview ? "text" : "password"} id="passfield" placeholder="Password"/>
                                        <InputRightElement>
                                            <IconButton variant="ghost" onClick={() => setpasswordview(!passwordview)} icon={passwordview ? <ViewIcon /> : <ViewOffIcon />}/>
                                        </InputRightElement>
                                    </InputGroup>
                                </FormControl>
                                )}
        ...
        <Flex justify="center" w="100%">
            <Box w={["50%","30%","15%"]}>
            {invalidUser && <Alert status="error" variant="top-accent"><AlertIcon /> <AlertTitle>Username is taken</AlertTitle> </Alert>}
            {invalidEmail && <Alert status="error" variant="top-accent" ><AlertIcon /><AlertTitle>Email is taken</AlertTitle> </Alert>}
